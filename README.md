...
- `GET /v1/models` 返回 `gpt-image-2`、`gpt-image-2.5-sunburst`、`gpt-image-2.5-flare`、`codex-gpt-image-2`、`auto`、`gpt-5`、`gpt-5-1`、`gpt-5-2`、`gpt-5-3`、`gpt-5-3-mini`、
  `gpt-5-mini`
- 支持通过 `n` 返回多张生成结果
- 支持生成可编辑 PPT 文件
- 支持生成可编辑 PSD 文件
...
- 支持 `gpt-image-2`、`gpt-image-2.5-sunburst`、`gpt-image-2.5-flare`、`codex-gpt-image-2`、`auto`、`gpt-5`、`gpt-5-1`、`gpt-5-2`、`gpt-5-3`、`gpt-5-3-mini`、`gpt-5-mini` 模型选择
- 编辑模式支持参考图上传
- 前端支持多图生成交互
...
| 字段   | 说明                                                                                                         |
|:-----|:-----------------------------------------------------------------------------------------------------------|
| 返回模型 | `gpt-image-2`、`gpt-image-2.5-sunburst`、`gpt-image-2.5-flare`、`codex-gpt-image-2`、`auto`、`gpt-5`、`gpt-5-1`、`gpt-5-2`、`gpt-5-3`、`gpt-5-3-mini`、`gpt-5-mini` |
...
| 字段                | 说明                                                 |
|:------------------|:---------------------------------------------------|
| `model`           | 图片模型，当前可用值以 `/v1/models` 返回结果为准，推荐使用 `gpt-image-2`；官网 2.5 可用 `gpt-image-2.5-sunburst`、`gpt-image-2.5-flare` |
| `prompt`          | 图片生成提示词                                            |
...
| 字段          | 说明                                            |
|:------------|:----------------------------------------------|
| `model`     | 图片模型，`gpt-image-2`、`gpt-image-2.5-sunburst`、`gpt-image-2.5-flare` |
| `prompt`    | 图片编辑提示词                                       |
| `n`         | 生成数量，当前后端限制为 `1-10`；多图请求会拆分为独立任务并行生成（默认） |
